     ...
     */
        ...
        _generateHTML: function (inst) {
            ...
            for (row = 0; row < numMonths[0]; row++) {
                ...
                group += "<div class='ui-datepicker-main-header'>";
                group += "<div class='ui-datepicker-prev' data-handler='prev' data-event='click' ><i class='icon-left-arrow'></i></div>";
                group += "<div class='ui-datepicker-data'>" + monthNames[drawMonth] + " - " + monthNames[drawMonth + 1] + " " + drawYear + "</div>";
                group += "<div class='ui-datepicker-next' data-handler='next' data-event='click' ><i class='icon-right-arrow'></i></div>";
                group += "<div class='ui-datepicker-reset' data-handler='hide' data-event='click'><img src='/static/default/img/ui-datepicker-reset.png'>Сбросить</div>";
                group += "<div class='ui-datepicker-closed' data-handler='hide' data-event='click' data-handler='close' data-event='click' ><i class='icon-close'></i></div>";
                group += "</div>";
        ...
        _generateMonthYearHeader: function (inst, drawMonth, drawYear, minDate, maxDate,
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    //если раскоментировать то возле месяца над календарем будет и год
