...
(function(factory) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
                ...
                //
                //  default is ['&#171;','&#187;']
                header_navigation: ['<span class="prev icon-left-arrow"></span>', '<span class="next icon-right-arrow"></span>'],
                ...
                //  months names
                months: ['Янв', 'Фев', 'Мар', 'Апр', 'Май', 'Июн', 'Июл', 'Авг', 'Сен', 'Окт', 'Нбр', 'Дек'],
            ...
            if (!(plugin.settings.always_visible instanceof jQuery)) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        icon = $('<span class="Zebra_DatePicker_Icon' + ($element.attr('disabled') === 'disabled' ? ' Zebra_DatePicker_Icon_Disabled' : '') + '"><i class="icon-date"></i></span>');
